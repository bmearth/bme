...
event_fields = ('id', 'title','description', 'print_description', 'year', 'slug', 'event_type', 'hosted_by_camp', 'located_at_art', 'other_location', 'check_location', 'url', 'contact_email', 'location_point', 'location_track', 'all_day', ('occurrence_set', ('start_time', 'end_time')))
