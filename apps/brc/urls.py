...
urlpatterns = patterns('',
     ...
     url(r'^(?P<year_year>\d{4})/playa_event/(?P<playa_event_id>\d+)/$', 'brc.views.playa_event_id', name="playa_event"),
     url(r'^(?P<year_year>\d{4})/playa_event/(?P<playa_event_id>\d+)/(?P<playa_occurrence_id>\d+)/$', 'brc.views.playa_occurrence_view', name="playa_occurrence"),
     url(r'^(?P<year_year>\d{4})/playa_events/$', 'brc.views.all_playa_events', name="playa_events"),
