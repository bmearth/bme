...
{% endfor %}{% endautoescape %}    };{% endblock %}
    ...
    // Base Layer
    var newLayer = new OpenLayers.Layer.OSM("2009 Map", "/osm_tiles2/${z}/${x}/${y}.png", {numZoomLevels: 19});
    ...
    var releaseLayer = new OpenLayers.Layer.OSM("2009 Map (Embargoed)", "/osm_tiles3/${z}/${x}/${y}.png", {numZoomLevels: 19});
